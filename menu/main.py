...
class TangramGame:
 ...
 _______  __   __    _______  _______  __    _  _______  _______  _______  _______ 
|       ||  | |  |  |       ||   _   ||  |  | ||   _   ||       ||       ||       |
|_     _||  | |  |  |    ___||  |_|  ||   |_| ||  |_|  ||  _____||_     _||    ___|
  |   |  |  |_|  |  |   | __ |       ||       ||       || |_____   |   |  |   |___ 
  |   |  |       |  |   ||  ||       ||  _    ||       ||_____  |  |   |  |    ___|
  |   |  |       |  |   |_| ||   _   || | |   ||   _   | _____| |  |   |  |   |___ 
  |___|  |_______|  |_______||__| |__||_|  |__||__| |__||_______|  |___|  |_______|

    """)
                    else:
                        print("""
 _______  __   __    _______  _______  ______    ______   ___   _______  _______  _______ 
|       ||  | |  |  |       ||       ||    _ |  |      | |   | |       ||       ||       |
|_     _||  | |  |  |    _  ||    ___||   | ||  |  _    ||   | |  _____||_     _||    ___|
  |   |  |  |_|  |  |   |_| ||   |___ |   |_||_ | | |   ||   | | |_____   |   |  |   |___ 
  |   |  |       |  |    ___||    ___||    __  || |_|   ||   | |_____  |  |   |  |    ___|
  |   |  |       |  |   |    |   |___ |   |  | ||       ||   |  _____| |  |   |  |   |___ 
  |___|  |_______|  |___|    |_______||___|  |_||______| |___| |_______|  |___|  |_______|
""")
